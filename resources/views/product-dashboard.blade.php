            ...
            <tbody x-data="{ modal: true }">
                @foreach ($data as $product)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <button class="px-5 py-2 bg-blue-900 rounded-lg" x-on:click="modal = !modal">
                                Show Image
                            </button>
                        </td>
                    </tr>
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div
                                ...
                                <h3 class="text-xl font-semibold text-gray-900 dark:text-white" x-text="modalImage">
